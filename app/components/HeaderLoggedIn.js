...
function HeaderLoggedIn(props) {
  ...
  function handleLogout() {
    ...
    appDispatch({ type: "flashMessage", value: "Logout realizado com sucesso." });
  }
  ...
  return (
    <div className="flex-row my-3 my-md-0">
      <a data-for="search" data-tip="Pesquisar" onClick={handleSearchIcon} href="#" className="text-white mr-2 header-search-icon">
      ...
      <Link data-for="profile" data-tip="Meu Perfil" to={`/profile/${appState.user.username}`} className="mr-2">
